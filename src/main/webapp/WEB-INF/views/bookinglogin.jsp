...
<html lang="ko" class="no-js" >
   <head>
      ...
      <title translate="CM-NBOOKING">네이버 예약</title>
       <link href="<%=request.getContextPath()%>/resevation-html-base/css/bookinglogin.css" rel="stylesheet">
   </head>
<body class="biz  ko" >
      ...
      <app>
         <toast-alert class="top_info hide booking_alert">
            ...
            <a href="<%=request.getContextPath()%>/mainpage" class="top_info_close"  data-tst_alt_close="0"> <i class="fn fn-close" aria-hidden="true"></i> <span class="sr_only" translate="CM-CLOSE">닫기</span> </a> 
         </toast-alert>
         <!---->
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  <h1 class="login_header"> <a href="<%=request.getContextPath()%>/mainpage"  class="nbooking_logo spr_bi txt_logo" > <span translate="CM-NBOOKING">네이버 예약</span> </a> </h1>
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="bookingChkForm" action="<%=request.getContextPath()%>/login" method="POST" onsubmit="return checkEmail();">
                        <h2 class="login_header_sub border_bottom"> <span translate="CM-NON_MEMBER_BK_CONFIRMATION">비회원 예약확인</span> </h2>
                        <div class="login_form"> 
                           <label class="label_form" for="email" translate="CM-BOOKING_NUMBER">예약자 이메일 입력</label> 
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="email" name="email" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일">  </div>
                        <button type="submit" form="bookingChkForm" class="login_btn confirm" id="bookingChkBtn"> <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!----> 
                     </form>
                  </div>
                  <!----> <!----> 
               </div>
